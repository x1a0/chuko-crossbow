...
class TestCubeRenderer extends IItemRenderer {
  val testCubeModel: TestCubeModel = new TestCubeModel()
  val resourceFile = "chukocrossbow:models/TestCube.png"
  ...
  override def renderItem(typ: ItemRenderType, item: ItemStack, data: Object*): Unit = {
    ...
    typ match {
      case ItemRenderType.EQUIPPED => // render in 3rd person
        ...
        testCubeModel.render(null, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F)
        GL11.glPopMatrix()
      ...
      case ItemRenderType.ENTITY =>
        ...
        testCubeModel.render(data(1).asInstanceOf[Entity], 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0625F)
        GL11.glPopMatrix()
