...
class ChukoCrossbowBaseModel extends ModelBase {
  ...
  val bodyLower: ModelRenderer = new ModelRenderer(this, 0, 0)
  ...
  val tail: ModelRenderer = new ModelRenderer(this, 0, 0)
  ...
  val wingLeft: ModelRenderer = new ModelRenderer(this, 0, 0)
  ...
  val wingRight: ModelRenderer = new ModelRenderer(this, 0, 0)
  ...
  val clipLower: ModelRenderer = new ModelRenderer(this, 0, 0)
  ...
  val clipUpper: ModelRenderer = new ModelRenderer(this, 0, 0)
  ...
  val loaderRight: ModelRenderer = new ModelRenderer(this, 0, 0)
